...
<tr><td style="background:#f8f4ee;padding:14px 24px;text-align:center;border-top:1px solid #e4e8f0;">
  <p style="font-size:11px;color:#8a94b0;margin:0;">🛡️ OneCallShield Admin · <a href="https://onecallshield.com/admin" style="color:#c9973a;text-decoration:none;">onecallshield.com/admin</a></p>
      ...
      const statusUrl = `https://onecallshield.com/status/${leadId}`;
...
@media only screen and (max-width:600px){.ec{width:100%!important;}.pad{padding:22px 16px!important;}.padsm{padding:0 14px 20px!important;}.ht{font-size:22px!important;}}</style></head>
<body style="margin:0;padding:0;background:#f0f4f8;">
<div style="display:none;max-height:0;overflow:hidden;font-size:1px;color:#f0f4f8;">You're all set! Your request is confirmed. Track your status anytime with your personal link.&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;</div>
...
<tr><td class="pad" align="center" style="padding:32px 28px 24px;">
  <p class="ht" style="font-family:Georgia,serif;font-size:24px;font-weight:700;color:#0d1f3c;line-height:1.25;margin:0 0 12px;">You're in good hands, ${firstName}. 🙌</p>
  <p style="font-size:15px;color:#5a6480;line-height:1.75;margin:0;">We've received your request and our team is <strong style="color:#0d1f3c;">personally reviewing it right now.</strong> We'll match you with one vetted, licensed agent who specializes in ${insuranceType}.</p>
</td></tr>
...
<tr><td class="padsm" style="padding:0 22px 22px;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0d1f3c;border-radius:12px;"><tr><td align="center" style="padding:22px 20px;">
    <p style="font-size:11px;color:rgba(255,255,255,0.4);text-transform:uppercase;letter-spacing:3px;margin:0 0 8px;">Track Your Request</p>
    <p style="font-family:Georgia,serif;font-size:17px;font-weight:700;color:#fff;margin:0 0 6px;">Your Personal Status Page</p>
    <p style="font-size:13px;color:rgba(255,255,255,0.5);margin:0 0 16px;line-height:1.5;">See real-time updates as we review your request and match you with your agent.</p>
    <a href="${statusUrl}" style="display:inline-block;background:#c9973a;color:#0d1f3c;text-decoration:none;font-weight:700;font-size:14px;padding:12px 28px;border-radius:10px;font-family:'Helvetica Neue',Arial,sans-serif;">View My Status →</a>
    <p style="font-size:11px;color:rgba(255,255,255,0.25);margin:12px 0 0;word-break:break-all;">${statusUrl}</p>
  </td></tr></table>
</td></tr>

<tr><td class="padsm" style="padding:0 22px 22px;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0d1f3c;border-radius:12px;"><tr><td align="center" style="padding:18px 14px;">
    <p style="font-family:Georgia,serif;font-size:15px;font-weight:700;color:#c9973a;margin:0 0 12px;">The One Call Guarantee™</p>
    <table cellpadding="0" cellspacing="0" style="margin:0 auto;"><tr>
      <td align="center" style="padding:0 10px;"><p style="font-family:Georgia,serif;font-size:22px;font-weight:700;color:#c9973a;line-height:1;margin:0;">1</p><p style="font-size:9px;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:2px;margin:3px 0 0;">Form</p></td>
      <td style="color:rgba(255,255,255,0.1);font-size:18px;padding:0 2px 6px;">·</td>
      <td align="center" style="padding:0 10px;"><p style="font-family:Georgia,serif;font-size:22px;font-weight:700;color:#c9973a;line-height:1;margin:0;">1</p><p style="font-size:9px;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:2px;margin:3px 0 0;">Agent</p></td>
      <td style="color:rgba(255,255,255,0.1);font-size:18px;padding:0 2px 6px;">·</td>
      <td align="center" style="padding:0 10px;"><p style="font-family:Georgia,serif;font-size:22px;font-weight:700;color:#c9973a;line-height:1;margin:0;">1</p><p style="font-size:9px;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:2px;margin:3px 0 0;">Call</p></td>
      <td style="color:rgba(255,255,255,0.1);font-size:18px;padding:0 2px 6px;">·</td>
      <td align="center" style="padding:0 10px;"><p style="font-family:Georgia,serif;font-size:22px;font-weight:700;color:#c9973a;line-height:1;margin:0;">0</p><p style="font-size:9px;color:rgba(255,255,255,0.35);text-transform:uppercase;letter-spacing:2px;margin:3px 0 0;">Spam</p></td>
    </tr></table>
  </td></tr></table>
</td></tr>

<tr><td class="padsm" align="center" style="padding:0 22px 26px;">
  <p style="font-size:13px;color:#5a6480;line-height:1.8;margin:0;">Questions? Reply to this email or visit <a href="https://onecallshield.com" style="color:#c9973a;font-weight:700;text-decoration:none;">onecallshield.com</a></p>
</td></tr>
...
<div style="text-align:center;margin-top:14px;"><a href="https://onecallshield.com/admin" style="display:inline-block;background:#c9973a;color:#0d1f3c;text-decoration:none;font-weight:700;font-size:13px;padding:11px 22px;border-radius:8px;">Review in Admin →</a></div>
    ...
    // ── TYPE 4: Consumer match notification ────────────────────────────────
    if (type === 'consumer_matched') {
      const { consumerEmail, consumerFirstName, agentFirstName, agentLastName,
              agentPhone, agentEmail, agentLicense, agentAgency, agentPhotoUrl,
              agentTypes, contactTime, insuranceType, leadId } = data;

      const html = `<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0">
<style>body,table,td,div,p{margin:0;padding:0;}body{-webkit-text-size-adjust:100%;background:#f0f4f8;font-family:'Helvetica Neue',Arial,sans-serif;}table{border-collapse:collapse;}
@media only screen and (max-width:600px){.ec{width:100%!important;}.pad{padding:22px 16px!important;}.padsm{padding:0 14px 20px!important;}.ht{font-size:21px!important;}}</style></head>
<body style="margin:0;padding:0;background:#f0f4f8;">
<div style="display:none;max-height:0;overflow:hidden;font-size:1px;color:#f0f4f8;">Great news! Your agent has been matched. Here's who will be calling you.&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;</div>
<table width="100%" cellpadding="0" cellspacing="0" style="background:#f0f4f8;"><tr><td align="center" style="padding:20px 10px;">
<table class="ec" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%;background:#fff;border-radius:14px;overflow:hidden;">
...
<tr><td align="center" style="background:#0d1f3c;padding:28px 24px 22px;">
  <div style="background:#c9973a;border-radius:50%;width:50px;height:50px;line-height:50px;text-align:center;font-size:22px;margin:0 auto 10px;">🛡️</div>
  <div style="font-family:Georgia,serif;font-size:22px;font-weight:700;color:#fff;margin-bottom:4px;">OneCallShield</div>
  <div style="font-size:10px;color:rgba(255,255,255,0.4);letter-spacing:3px;text-transform:uppercase;">Your Agent Has Been Matched</div>
</td></tr>
<tr><td style="background:#c9973a;height:3px;font-size:3px;">&nbsp;</td></tr>

<tr><td class="pad" align="center" style="padding:28px 28px 22px;">
  <p class="ht" style="font-family:Georgia,serif;font-size:23px;font-weight:700;color:#0d1f3c;line-height:1.25;margin:0 0 10px;">Great news, ${consumerFirstName}! 🎉</p>
  <p style="font-size:14px;color:#5a6480;line-height:1.75;margin:0;">We've personally selected your agent for your <strong style="color:#0d1f3c;">${insuranceType}</strong> request. Here's who will be reaching out to you.</p>
</td></tr>

<tr><td class="padsm" style="padding:0 22px 22px;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8f4ee;border-radius:14px;overflow:hidden;">
    <tr><td style="padding:14px 18px 4px;"><p style="font-size:10px;font-weight:700;color:#8a94b0;text-transform:uppercase;letter-spacing:0.1em;margin:0;">✅ Your Matched Agent</p></td></tr>
    <tr><td style="padding:12px 18px 18px;">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td style="width:72px;vertical-align:top;">
            ${agentPhotoUrl
              ? `<img src="${agentPhotoUrl}" width="64" height="64" style="width:64px;height:64px;border-radius:50%;object-fit:cover;border:3px solid #c9973a;display:block;" alt="${agentFirstName}">`
              : `<div style="width:64px;height:64px;border-radius:50%;background:#0d1f3c;border:3px solid #c9973a;display:flex;align-items:center;justify-content:center;font-size:24px;text-align:center;line-height:64px;">👤</div>`
            }
          </td>
          <td style="vertical-align:top;padding-left:14px;">
            <p style="font-family:Georgia,serif;font-size:18px;font-weight:700;color:#0d1f3c;margin:0 0 3px;">${agentFirstName} ${agentLastName}</p>
            <p style="font-size:13px;color:#5a6480;margin:0 0 4px;">${agentAgency || 'Independent Agent'}</p>
            ${agentLicense ? `<p style="font-size:12px;color:#2d7a4f;font-weight:600;margin:0 0 4px;">License #${agentLicense}</p>` : ''}
            <p style="font-size:12px;color:#8a94b0;margin:0;">${(agentTypes||[]).slice(0,3).join(' · ')}</p>
          </td>
        </tr>
      </table>
      <div style="margin-top:14px;background:#0d1f3c;border-radius:10px;padding:12px 16px;text-align:center;">
        <p style="font-size:12px;color:rgba(255,255,255,0.5);margin:0 0 3px;">Expect your call</p>
        <p style="font-size:16px;font-weight:700;color:#c9973a;margin:0;">📞 ${contactTime || 'Anytime'}</p>
      </div>
    </td></tr>
  </table>
</td></tr>
...
<tr><td class="padsm" style="padding:0 22px 22px;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#e8f5ee;border-radius:12px;border-left:4px solid #2d7a4f;">
    <tr><td style="padding:16px 18px;">
      <p style="font-size:13px;font-weight:700;color:#2d7a4f;margin:0 0 6px;">What happens next</p>
      <p style="font-size:13px;color:#5a6480;line-height:1.65;margin:0;">${agentFirstName} will call you at your preferred time. They know you're expecting their call. One conversation. Real quotes. Zero pressure. Your information was shared with <strong>no one else.</strong></p>
    </td></tr>
  </table>
</td></tr>
...
<tr><td align="center" style="background:#f8f4ee;padding:18px 22px;border-top:1px solid #e4e8f0;">
  <p style="font-family:Georgia,serif;font-size:12px;font-weight:700;color:#0d1f3c;margin:0 0 5px;">🛡️ OneCallShield</p>
  <p style="font-size:11px;color:#8a94b0;line-height:1.8;margin:0;">One Call. Real Coverage. Zero Hassle.<br>
  <span style="font-size:10px;color:#b8c0cc;">© 2026 OneCallShield LLC · Your data is protected</span></p>
</td></tr>

</table></td></tr></table></body></html>`;

      await sendEmail(consumerEmail, `Your agent has been matched — OneCallShield`, html);
      return { statusCode: 200, headers, body: JSON.stringify({ success: true }) };
    }
